...
public partial class Home : ContentPage
{
  ...
  private async void OnFestivalTapped(object? sender, TappedEventArgs e)
  {
    ...
    await Shell.Current.GoToAsync(nameof(EventDetail), new Dictionary<string, object>
    {
      ["EventData"] = eventData
    });
  }

  private async void OnTechTapped(object? sender, TappedEventArgs e)
  {
    var eventData = new EventSummary
    {
